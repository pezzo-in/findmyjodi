                                ...
                                <div class="sidebar-main">
                                    ...
                                    <div class="sidebar-cont">
                                		<ul class="list1">
											...
											?>
                                            <li><a href="javascript:;" id="new_msg">New</a> (<?php echo count($count_total_msgs); ?>)</li>
                                            ...
                                            <li><a href="javascript:;">Filtered</a> (0)</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sidebar-main">
                                    ...
                                    <div class="sidebar-cont">
                                		<ul class="list1">
                                            <li><a href="javascript:;">Replies received</a> (0)</li>
                                            <li><a href="javascript:;">Read by members</a> (0)</li>
                                            <li><a href="javascript:;">Unread</a> (0)</li>
                                            <li><a href="javascript:;">Not Interested</a> (0)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<?php echo $each_msg[0]['caste']; ?> (Caste No Bar) | Location : <?php echo $each_msg[0]['city']; ?>, <?php echo $each_msg[0]['country']; ?> | Education : <?php echo $each_msg[0]['education'];  if($each_msg[0]['occupation'] != "Any" ) { ?>| Occupation : <?php echo $each_msg[0]['occupation']; } ?></p><a href="view_profile.php?id=<?php echo $each_msg[0]['mem_id']; ?>">View Full Profile</a> </div>
                                    ...
                                    <div class="cb-msgs">
                                    	...
                                    	<h2>Interests</h2>
                                         ...
                                         <a  href="javascript:;" class="not_int_msg_class" id="not_int_<?php echo $each_msg[0]['member_id']."_".$msg_id; ?>" >  Not Interested</a>
                                        <?php
                        	...
                        	<div class="sidebar">
                                <div class="sidebar-main">
                                    ...
                                    <div class="sidebar-cont">
                                		<ul class="list1">
											...
											?>
                                            <li><a href="javascript:;" id="not_interested_int">Not Interested</a> (<?php echo count($count_total_not_int); ?>)</li>
                                            <li><a href="javascript:;">Filtered</a> (0)</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sidebar-main">
                                    ...
                                    <div class="sidebar-cont">
                                		<ul class="list1">
                                            <li><a href="javascript:;">Replies received</a> (0)</li>
                                            <li><a href="javascript:;">Read by members</a> (5)</li>
                                            <li><a href="javascript:;">Unread</a> (2)</li>
                                            <li><a href="javascript:;">Not Interested</a> (0)</li>
                                        </ul>
                                    </div>
                                </div>
							...
							$msg_id = $each_msg[0]['msg_id'];
                                ...
                                <div class="basicview">
                                	<div class="showbasiccontent col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row-top"><a href="#" class="floatl"><?php echo $each_msg[0]['name']; ?> (<?php echo $each_msg[0]['member_id']; ?>)</a> <a href="#"><span class="icon phoneicon "></span></a><div class="smalltxt floatr">Received : 20 hours ago <!--<a href="#" class="icon-delete"><img src="images/delete-icon.png" /></a>--></div></div><br />
<span class="smalltxt">Last Login : 2 hours ago</span><br />
<p><?php echo $each_msg[0]['age']; ?> Yrs, <?php echo $each_msg[0]['height']." Inch" ?> | <?php echo $each_msg[0]['religion']; ?>: <?php echo $each_msg[0]['caste']; ?> | Location : <?php echo $each_msg[0]['city']; ?>, <?php echo $each_msg[0]['country']; ?> | Education : <?php echo $each_msg[0]['education']; 
...
<?php
$select_banner = "select * from advertise where adv_position = 'Notification Bottom (954 X 100)'";
$db_banner = $obj->select($select_banner);
if(count($db_banner) > 0) 
{
?>
