...

{
		...
		echo "<script>window.location='edit_horoscope.php'</script>";	
		     ...
		     <h3>Add/Edit Horoscope</h3>
                    ...
                    <form name="photo_upload_form" method="post" style="padding-top:10px" enctype="multipart/form-data">
                        ...
                        <div class="new_acc">
                           ...
                           <input type="text" name="horoscope" id="horoscope" value="<?php if(isset($logged_in_member[0]['horoscope_match'])){ echo $logged_in_member[0]['horoscope_match']; } ?>" />

                           <input type="submit" name="save_horoscope_match" class="submit_btn_new" value="Update">
