...
<div class="row-top"><a href="view_profile.php?id=<?php echo $each_msg[0]['mem_id']; ?>" class="floatl"><?php echo ucfirst($each_msg[0]['name']); ?> (<?php echo $each_msg[0]['member_id']; ?>)</a> <!--<a href="#"><span class="icon phoneicon "></span></a>-->
   <?php
