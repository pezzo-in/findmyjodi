...
if($_GET['hint'] == "msg_sent")

{

	$select_new_msgs = "select * from messages where from_mem = '".$_SESSION['logged_user'][0]['member_id']."' group by to_mem order by id desc";			
		  ...
		  <div class=""> <!--basicview-->
			...
			<div class="showbasiccontent col-md-12 col-sm-12 col-xs-12">
			  ...
			  <div class="prfl-details">
				...
				<p><?php echo $each_msg[0]['age']; ?> Yrs, <?php echo $each_msg[0]['height']." Inch" ?> | <?php echo $each_msg[0]['religion']; ?>: <?php echo $each_msg[0]['caste']; ?>(Caste No Bar) | Location : <?php echo $each_msg[0]['city']; ?>, <?php echo $each_msg[0]['country']; ?> | Education : 
				<?php
					...
					<div class="lightbox_cont full">
					  ...
					  <div class="showbasiccontent col-md-12 col-sm-12 col-xs-12">
						...
						<div class="prfl-details">
						  ...
						  <p><?php echo $each_msg[0]['age']; ?> Yrs, Height <?php echo $each_msg[0]['height']; ?> | <?php echo $each_msg[0]['religion']; ?>: <?php echo $each_msg[0]['caste']; ?> (Caste No Bar) | Location : <?php echo $each_msg[0]['city']; ?>, <?php echo $each_msg[0]['country']; ?> | Education : 
						  <?php
						$select_education="select * from education_course where Id='".$each_msg[0]['education']."'";
						$db_education=$obj->select($select_education);
						echo $db_education[0]['Title'];
						?>
						  <?php if($each_msg[0]['occupation'] != "Any" && $each_msg[0]['occupation'] != "" ) { ?>| Occupation : <?php echo $each_msg[0]['occupation']; } ?></p>
					  ...
					  <div class="cb-msgs">
						...
						<?php
													...
													//$select_new_msgs2 = "select * from messages where from_mem = '".$_SESSION['logged_user'][0]['member_id']."' and parent_id = '0' and to_mem = '".$messages[$i]['from_mem']."' order by id desc";

													

													$select_new_msgs2 = "select * from messages where from_mem = '".$_SESSION['logged_user'][0]['member_id']."' and  to_mem = '".$messages[$i]['to_mem']."' order by id";
						  ...
						  $replies_to_mem = "select * from replies where to_mem = '".$_SESSION['logged_user'][0]['member_id']."' and to_msg_id = '".$msg['id']."'";
...

	{
		...
		echo "Currently You have no any sent messages";
...
echo $db_education[0]['Title'];
?>
<?php if($each_msg[0]['occupation'] != "Any" ) { ?>| Occupation : <?php echo $each_msg[0]['occupation']; } ?></p><a href="view_profile.php?id=<?php echo $each_msg[0]['mem_id']; ?>">View Full Profile</a> </div>
...
<ul class="pagination" style="display:none"><li class="active"><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li><a href="#">4</a></li><li><a href="#">5</a></li><li>&nbsp; of &nbsp;</li><li class="inactive"><a href="#">1</a></li></ul>
                                ...
                                <div class=""  id="id_<?php echo $each_msg[$i]['member_id']."_".$msg_id; ?>"> <!--basicview-->
    ...
    <p><?php echo $each_msg[$i]['age']; ?> | <?php echo $each_msg[$i]['religion']; ?>: <?php echo $each_msg[$i]['caste']; ?> | Location : <?php echo $each_msg[$i]['city']; ?>, <?php echo $each_msg[$i]['country']; ?>| Education : 
	<?php
	$select_education="select * from education_course where Id='".$each_msg[$i]['education']."'";
	$db_education=$obj->select($select_education);
	echo $db_education[0]['Title'];
	?>
	| Occupation : <?php echo $each_msg[$i]['occupation']; ?></p>
...
Listed here are the members whose interest you have declined.
                                ...
                                <div class=""  id="accept_div_<?php echo $each_msg[$i]['member_id']."_".$messages[$i]['exp_int_id']; ?>"> <!--basicview-->
