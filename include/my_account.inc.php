...
<?php unset($_SESSION['profile_update']); } ?>
        ...
        <div class="my-account content col-md-9 col-xs-12 col-sm-12">
...
<?php if(!empty($logged_in_member[0]['wishtosettle'])) { ?><ul class="col-md-6 col-sm-6 col-xs-12"><li>Where do you wish to settle?</li><li>:</li><li><?php echo $logged_in_member[0]['wishtosettle']; ?></li></ul><?php } ?>
...
<?php if(!empty($logged_in_member[0]['school'])) { ?><ul class="col-md-6 col-sm-6 col-xs-12"><li>School</li><li>:</li><li><?php echo $logged_in_member[0]['school']; ?></li></ul><?php } ?> 
<?php if(!empty($logged_in_member[0]['college'])) { ?><ul class="col-md-6 col-sm-6 col-xs-12"><li>College</li><li>:</li><li><?php echo $logged_in_member[0]['college']; ?></li></ul><?php } ?>
  
                          <?php if(!empty($logged_in_member[0]['inttowork'])) { ?> <ul class="col-md-6 col-sm-6 col-xs-12"><li>Interested to work after marriage?</li><li>:</li><li>
                ...
                <?php if($db_memebr_hobbies_interest[0]['hobbies']!='' || $db_memebr_hobbies_interest[0]['interests']!='' || $db_memebr_hobbies_interest[0]['music']!='' || $db_memebr_hobbies_interest[0]['read_book']!='' || $db_memebr_hobbies_interest[0]['movies']!='' || $db_memebr_hobbies_interest[0]['sports']!='' || $db_memebr_hobbies_interest[0]['cuisine']!='' || $db_memebr_hobbies_interest[0]['dress_style']!='' || $db_memebr_hobbies_interest[0]['spoken_lang']!=''){ ?>
                 <div class="row-detail row-detail-hobbies">
                	<span class="hobbies1"></span><h3>Hobbies & Interests</h3>
                     ...
                     <?php if($db_memebr_hobbies_interest[0]['interests']!=''){?><ul class="col-md-6 col-sm-6 col-xs-12"><li>Interests</li><li class="nthchild2">:</li><li>
					 <?php
