...
<?php		
		...
		$select_new_msgs = "select photo_request.*, photo_request.Id as photo_request_id from photo_request right join members on photo_request.To_mem_id=members.id where photo_request.From_mem_id = '".$_SESSION['logged_user'][0]['id']."' AND members.is_profile_active='Y' order by photo_request.Id DESC";
...
<div class="content">
  ...
  <?=$PAGING->show_paging("photo_request_send.php");?>
...

									  {
										  	...
										  	$sql2 = "SELECT members.*,members.id as mem_id,member_photos.photo,messages.id as 
													...
													msg_id,messages.* FROM messages,members 
													 ...
													 members.id = '".$messages[$i]['To_mem_id']."'"; 
