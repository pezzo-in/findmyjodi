...

{
 ...
 // var $DBASE             = "expilead_webepreneur";       // Set name of database to use           
  ...
  //var $SERVER         = "localhost";  // Set server name                 
    ...
    var $DBASE             = "fmj_sandbox";       // Set name of database to use         online:    "dphs_dphs"

	var $USER             = "fmj";          // Set database username            online:    "dphs" 	

	var $PASS             = "^B-?pLXhoa_{";              // Set darabase R/W password      online:    "jaydev"

	var $SERVER         = "localhost";  // Set server name                online:    "localhost" 

	var $SITEURL         = "http://sandbox.findmyjodi.com/"; 
