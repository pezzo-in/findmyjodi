...
$sql= "SELECT member_plans.*,members.id as mem_id, members.mobile_no FROM `member_plans`, members where members.id=member_plans.member_id group by member_id desc";
						...
						<?php for($i=0;$i<count($res);$i++){?>
                                ...
                                <?php } ?>
                                 <td><?php echo ($i+1);?></td> 	
                                   ...
                                   <td><?php if($db_plan[0]['plan_name'] == "Gold") { echo '<span class="btn mini gold">'."Gold".'</span>'; } 
								   elseif($db_plan[0]['plan_name'] == "Platenium") { echo '<span class="btn mini platinum">'."Platenium".'</span>'; }
								    elseif($db_plan[0]['plan_name'] == "Free") { echo '<span class="btn mini red">'."Free".'</span>'; }
