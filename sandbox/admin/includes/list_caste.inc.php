...
if(isset($_GET['id']))
{
	$sqld="delete from caste where id = '".$_GET['id']."' ";
	$obj->sql_query($sqld);
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="btn-group" style="margin-bottom:10px; float:right">
                    <a href="add_new_caste.php"><button id="sample_editable_1_new" class="btn green">
                    Add New <i class="icon-plus"></i>
                    </button></a>
                </div>
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i>List Caste</div>
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <tbody>
                            <?php for($j=0;$j<count($ans);$j++){?>
                            <?php $sql_religions = "select * from religions where id = '".$ans[$j]['religion_id']."'";
							 		$db_religions = $obj->select($sql_religions); ?>
                                <tr>
                                	<td style="display:none"></td>
                                    <td><?php echo ($j+1);?></td>
                                     <td><?php echo $db_religions[0]['religion'];?></td>
                                    <td><?php echo $ans[$j]['caste'];?></td>
                                    <td class="hidden-480">
                                    <a href="add_new_caste.php?id=<?php echo $ans[$j]['id'];?>" class="btn mini purple"><i class="icon-edit"></i> Manage</a>
                                    </td>
                                </tr> 
                                <? }?>                               
                            </tbody>
