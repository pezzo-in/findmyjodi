<?php 
$sql="select * from mobile_codes order by id";
$ans=$obj->select($sql);
if(isset($_GET['id']))
{
	$sqld="delete from mobile_codes where id = '".$_GET['id']."' ";
	$obj->sql_query($sqld);
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="btn-group" style="margin-bottom:10px; float:right">
                    <a href="add_new_country.php"><button id="sample_editable_1_new" class="btn green">
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <?php for($i=0;$i<count($ans);$i++){?>
                                <tr>
                                    ...
                                    <td><?php echo $ans[$i]['mob_code'];?></td>
                                    <td><?php echo $ans[$i]['curr_code'];?></td>	                                   
                                    <td class="hidden-480">
                                    <a href="add_new_country.php?id=<?php echo $ans[$i]['id'];?>" class="btn mini purple"><i class="icon-edit"></i> Manage</a>
                                    </td>
                                </tr> 
                                <? }?>                               
                            </tbody>
