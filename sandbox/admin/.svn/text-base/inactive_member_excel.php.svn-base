...
$fp = fopen('excel/inactive_members_'.date('Y-m-d').'.xls', 'w');
...
$file = 'excel/inactive_members_'.date('Y-m-d').'.xls';
?>
Please Wait...
<a href="<?php echo 'excel/inactive_members_'.date('Y-m-d').'.xls'; ?>" id="link_save"></a>
<script>
