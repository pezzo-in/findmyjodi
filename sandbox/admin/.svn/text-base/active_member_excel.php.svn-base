...
$fp = fopen('excel/active_members_'.date('Y-m-d').'.xls', 'w');
...
$file = 'excel/active_members_'.date('Y-m-d').'.xls';
?>
Please Wait...
<a href="<?php echo 'excel/active_members_'.date('Y-m-d').'.xls'; ?>" id="link_save"></a>
<script>
