...
<?php if(!empty($members[0]['manglik_dosham'])) { ?><ul><li>Manglik</li><li>:</li><li>
...
<?php if(!empty($members[0]['horoscope_match'])) { ?><ul><li>Horoscope </li><li>:</li><li><?php echo $members[0]['horoscope_match']; ?></li></ul><?php } ?>
                </div>
                <?php } ?>
