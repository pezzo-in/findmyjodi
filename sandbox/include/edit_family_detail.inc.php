...

{
		...
		echo "<script>window.location='edit_family_detail.php'</script>";	
...
?>
	...
	<form name="photo_upload_form" method="post" style="padding-top:15px" enctype="multipart/form-data">
         ...
         <label>Family Status</label>
             ...
             <select id="drpFamilyValues" name="drpFamilyValues" onchange="return check_form()"  tabindex="19" style="clear:none; margin-left:65px;">	
                ...
                <input type="submit" name="save_family_details" class="submit_btn_new" value="Update">
