...
defined('USER') ?null:define('USER','fmj');

defined('PASS') ?null:define('PASS','^B-?pLXhoa_{');

defined('DB') ?null:define('DB','fmj_sandbox');
...
//date_default_timezone_set('Asia/Kolkata');
 ...
 $srcDB='fmj_sandbox'; // the database that contains your web site users
