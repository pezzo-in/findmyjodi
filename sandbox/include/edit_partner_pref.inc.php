...
?>
      ...
      <div class="content">
		...
		<div class="new_acc">
        	...
        	<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="editpartpref">
				...
				<tr>
                 ...
                 <tr>
                    ...
                    <td><select id="drpMaritalStatus" name="drpMaritalStatus"  tabindex="1" style="clear:none;">
                ...
                <tr>
                    ...
                    <td><select id="drpHeight" name="drpHeight"  tabindex="6" style="clear:none;">
                ...
                <tr>
                    ...
                    <td><select id="drpPhysicalStatus" name="drpPhysicalStatus"  tabindex="10" style="clear:none;">
                ...
                <tr>
                    ...
                    <select name="drpReligion" id="drpReligion" onchange="change_religion(this.value);" tabindex="5" style="clear:none;">
                ...
                <tr>
                    ...
                    <td><select name="drpMotherlanguage" id="drpMotherlanguage" tabindex="10" style="clear:none;" >
                ...
                <tr>
                    ...
                    <select name="drpCountry" id="drpCountry"  tabindex="6" style="clear:none;">
            ...
            <td><select id="drpEducation" name="drpEducation"  tabindex="7" style="clear:none;">
        <option value="">--Select--</option>
					<?php
                ...
                <tr>
                    ...
                    <td><input type="text" name="city" id="city" value="<?php echo $logged_in_member[0]['city']; ?>" tabindex="5" style="clear:none;"> </td>
