	...
	?>
                ...
                <div class="row-detail">
                    ...
                    <?php if(!empty($logged_in_member[0]['profile_for'])) { ?><ul><li>Created For</li><li>:</li><li><?php echo $logged_in_member[0]['profile_for']; ?></li></ul><?php } ?>
                     ...
                     <?php if(!empty($logged_in_member[0]['city'])) { ?><ul><li>Residing City</li><li>:</li><li><?php echo $logged_in_member[0]['city']; ?></li></ul><?php } ?>
                ...
                <div class="row-detail">
                	<h3><?php //echo $logged_in_member[0]['name']; ?> Education & Occupation</h3>
                ...
                <div class="row-detail">
                   ...
                   <?php if(!empty($logged_in_member[0]['physical_status'])) { ?><ul><li>Physical Status</li><li>:</li><li><?php echo $logged_in_member[0]['physical_status']; ?></li></ul><?php } ?>
                </div>
                <?php } ?>
                ...
                <?php if($logged_in_member[0]['date_of_birth']!='' || $logged_in_member[0]['country']!='' ){ ?>
                <div class="row-detail">
