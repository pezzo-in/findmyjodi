...
<?php			
		...
		$select_new_msgs = "select photo_request.*, photo_request.Id as photo_request_id from photo_request right join members on photo_request.From_mem_id=members.id where photo_request.To_mem_id = '".$_SESSION['logged_user'][0]['id']."' AND members.is_profile_active='Y' order by photo_request.Id DESC";
...
<div class="content col-md-9 col-sm-12 col-xs-12">
  ...
  <?=$PAGING->show_paging("photo_request_received.php");?>
...

									  {
										  	...
										  	$sql2 = "SELECT members.*,members.id as mem_id,member_photos.photo,messages.id as 
													...
													msg_id,messages.* FROM messages,members 
													 ...
													 members.id = '".$messages[$i]['From_mem_id']."'"; 
...
?>
		...
		?>
          ...
          <a href="view_profile.php?id=<?php echo $each_msg[0]['mem_id']; ?>">View Full Profile</a><a href="javascript:void(0)" style="float:right;" onclick="return delete_intrest_photo('accept_div_<?php echo $each_msg[0]['member_id']."_".$messages[$i]['exp_int_id']; ?>','<?php echo $messages[$i]['Id']; ?>');"><img src="img/delete.png" style="border:none;" height="16" width="16" title="Delete"></a>
...
function delete_intrest_photo(str,id){
