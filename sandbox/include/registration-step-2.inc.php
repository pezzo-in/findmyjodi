    ...
    <div class="new_acc">           
         ...
         <hr />
     		<table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="tbl_control">
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">Residing state</label></td>
         ...
         <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="tbl_control">
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">Employed in</label></td>
         ...
         <?php /*?><div class="left" style="width:100%">
          ...
          <div class="left" style="width:100%">
            ...
            <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="tbl_control">
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">Living with parents</label></td>
             ...
             <span id="fstatus" class="err_msg">Select Living with parents</span> 
             	...
             	<tr>
                	<td width="20%"><label style="margin-top:-18px">Family Status</label></td>
             ...
             <span id="fstatus" class="err_msg">Select family status</span> 
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">Family Type</label></td>
             ...
             <span id="ftype" class="err_msg">Select family type</span> 
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">Family Values</label></td>
             ...
             <span id="fvalue" class="err_msg">Select family values</span>              
                ...
                <tr>
                	<td width="20%"><label style="margin-top:-18px">About Yourself</label></td>
