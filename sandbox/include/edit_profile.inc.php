...
.left{float: left;
    margin-left: 20px;
    width: auto;}
.editprof ul{width:50%;}
.editprof ul li { width:auto;}
.editprof ul li label{ display:block;}
</style>
<?php
session_start();
...
if(isset($_POST['submit']))
{
	...
	$new_date=$_POST['dob']; 
	$dob = date('Y-m-d',strtotime($new_date));
...
?>
        ...
        <div class="content col-md-9 col-sm-12 col-xs-12">
               ...
               <div class="row-detail new_acc editprof">
                  <h3>More About Me</h3>
                   ...
                   <ul><li> <label>Gender</label><br class="clear" />
                            ...
                            <label class="radiobtn">
                                <input type="radio" value="F" name="Rdgender" id="Rdgenderf" <?php if($logged_in_member[0]['gender'] == 'F') { ?> checked="checked" <?php } ?> />Female
                            </label>
                            </div>
                   </li></ul>
                   ...
                   <ul><li><label>Marital Status</label><?php
					...
					?>
                    <select name="mari_status" id="mari_status" onchange="return check_form()">
                    ...
                    <ul><li><label>Matrimony Profile For</label><select id="drpProfFor" name="drpProfFor"  onchange="return check_form()">
                                <option value="">-Select-</option>
                    ...
                    <ul><li style="width:100%"><label>Mobile Number</label><br clear="all" />
							 	<?php
                                ...
                                <?php } ?>
                                </select><input type="text" name="txtMobNo" value="<?php echo $logged_in_member[0]['mobile_no']; ?>"  id="txtMobNo" onchange="return check_form()" />
                    </li></ul>
                    ...
                    <div class="row-detail new_acc editprof">
                          <h3>Education & Occupation</h3>
                           <ul><li><label>Education</label>
                                   <select id="education"  name="education" onchange="return check_form()" >
                            ...
                            <ul><li><label>Employed In</label>
                                    <select id="employed_in"  name="employed_in" onchange="return check_form()"  >	
                                        <option value="">--Select--</option>
                             ...
                             <ul><li><label>Annual Income</label>
                                    ...
                                    ?>
                                    <select name="annual_income" id="annual_income" onchange="return check_form()">
                                        <option value=""> -Select- </option>
                                        <?php foreach($data as $res) { ?>
                            ...
                            <ul><li> <label>Occupation</label>
                                    ...
                                    ?>
                                    <select name="occupation" id="occupation"  onchange="return check_form()" />
                                        <option value="">Select</option>
                                        <?php foreach($data as $res) { ?>
                    ...
                    <div class="row-detail new_acc editprof">
                          <h3>Physical Appearance & Looks</h3>
                           <ul><li><label>Height</label>
                                    <select id="drpHeight" name="drpHeight" onchange="return check_form()" >
                             ...
                             <ul><li><label>Weight</label>
                                        <select id="drpWeight" name="drpWeight" onchange="return check_form()" >
          ...
          <input type="text" class="date-picker" value="<?php echo date('d/m/Y',strtotime($logged_in_member[0]['date_of_birth'])); ?>" id="dob" name="dob" />
                            ...
                            <ul><li><label>Place of Birth</label>
                   					 <div><input type="text" name="place_of_birth" id="place_of_birth" value="<?php echo $logged_in_member[0]['place_of_birth']; ?>"  onchange="return check_form()" /></div>
                    		</li></ul>
                    </div>
                    ...
                    <div class="row-detail new_acc editprof">
                          <h3>Family</h3>
                           <ul><li><label>Brothers</label>
                             ...
                             <select id="num_bro_married" name="num_bro_married" style="width:80px; clear:none;">	
                            ...
                            <ul><li style="width:100%"><label>Sisters</label>
									<br class="clear" />			
                                     <select id="num_sis" name="num_sis" style="width:80px;">	
                                                <option value="">Select</option>
                                                <?php for($i=1;$i<=10;$i++) { ?>
                                     ...
                                     <select id="num_sis_married" name="num_sis_married"  style="width:80px; clear:none;">
                                                <option value="">Select</option>
                            ...
                            <ul><li><label>Family Values</label>
									<select id="drpFamilyValues" name="drpFamilyValues" onchange="return check_form()"  tabindex="19">	
                        				<option value="">--Select--</option>
                            ...
                            <ul><li><label>Family Type</label>
										<select id="drpFamilyType" name="drpFamilyType" onchange="return check_form()"  tabindex="18">	
                        			        <option value="">--Select--</option>
                            ...
                            <ul><li><label>Family Status</label>
									 <select id="drpFamilyStatus" name="drpFamilyStatus" onchange="return check_form()"  tabindex="17">	
                        					<option value="">--Select--</option>
                     ...
                     <div class="row-detail new_acc editprof">
                           <ul><li><label><input type="checkbox" name="mail_alerts" style="margin-right:7px;" value="1" <?php if($logged_in_member[0]['mail_alerts']==1){ ?> checked="checked" <?php } ?> />Do you want mail alerts?</label><br /><br />
							<?php
								...
								{
								?>
								<label><input type="checkbox" name="is_featured" value="Y" style="margin-right:7px;" <?php if($logged_in_member[0]['is_featured']=="Y"){ ?> checked="checked" <?php } ?> />Featured Profile</label>
                    ...
                    <div class="new_acc">           
                         ...
                         <div class="terms_line paddL-0">
                                <input type="submit" name="submit" value="Update" onclick="return validate()" class="update_btn_new1" />
                         </div>
                    </div>            
          </form>
          </div>
	 ...
	 function check_form()
	 {
		...
		$('#drpWeight').css('border','1px solid #ccc');
		...
		if(document.getElementById('drpWeight').value=='')
		{
			$('#drpWeight').css('border','1px solid red');
	...
	if(drpProfFor == 0 && username== 0 && drpReligion == 0 && drpCaste==0 && drpCountry==0 && dob==0 && drpMotherlanguage==0 && txtMobNo==0 && about_me == 0 && drpBodyType == 0 && drpLiving == 0 && drpFamilyValue == 0 && drpSmoking == 0 && drpDrinking == 0 && drpEatingHabits == 0 && mari_status == 0&& drpWeight ==0 && drpHeight ==0 )
	{
		return true;
	}
	else
...
$('#partner_pref').click( function() {
	...
	if(drpAgeFrm==0 && drpAgeTo==0 && drpReligion==0 && drpCaste==0 && drpMaritalStatus==0 && drpBodyType==0 && about_me == 0 && drpLiving == 0 && drpFamilyValue == 0 && drpEatingHabits == 0)
		{
