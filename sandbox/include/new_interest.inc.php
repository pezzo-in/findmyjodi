...
<div class="img-count controls"><a href="javascript:;" class="prev"><img src="images/blue-arrow2.png" /></a><span class="caption">&nbsp;</span><a href="javascript:;" class="next"><img src="images/blue-arrow1.png" /></a></div>
        ...
        <div class="prfl-details">
          ...
          <?php //$time11 = explode(' ',strtotime($messages[$i]['created_date'])); ?>
...
?>
            ...
            <div class="smalltxt floatr">Received : <?php echo $str; ?> ago</div>
...
?>
     ...
     | <a class="need_more_time" id="needtime_<?php echo $each_msg[0]['member_id']."_".$messages[$i]['exp_int_id']."_".$each_msg[0]['name']; ?>" href="javascript:;">Need More Time</a>
      ...
      <?php } ?> | <a href="javascript:void(0)" style="float:right;" onclick="return delete_intrest('accept_div_<?php echo $each_msg[0]['member_id']."_".$messages[$i]['exp_int_id']; ?>','<?php echo $messages[$i]['id']; ?>');"><img src="img/delete.png" style="border:none;" height="16" width="16" title="Delete"></a>

        

          <div class="left-msg int" style="display:none">Interested in your profile. Kindly respond at the earliest.</div>

          <div class="floatr" style="display:none"><a href="#" class="btn-pink btn"><span>Accept</span></a><a href="#" class="btn-blue1 btn"><span>Need More Info</span></a><a href="#" class="btn-blue1 btn"><span>Need More Time</span></a><a href="#" class="btn-blue1 btn"><span>Not Interested</span></a><a href="#">Delete</a></div>
...
$('.not_int_msg_class').click(function() {
	...
	$('.need_more_time').click(function() {
		 ...
		 var name = exploded[3];
				...
				to_mem:exploded[2],to_id:exploded[1],
