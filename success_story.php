...
<title>Success Story - Find My Jodi</title>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("txtHint234").innerHTML=xmlhttp.responseText;
    }
  }
...
<script>
	$(document).ready(function(){
		...
		$(".success_story").colorbox({innerWidth:"400px;", maxWidth:"400px;", innerHeight:"130px;", height:"130px;", xhrError: "Success story submited. Wait for admin approval."});
	});	
</script> 
</body>
</html>
