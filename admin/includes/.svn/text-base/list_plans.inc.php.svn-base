<?php 
$sql="select * from membership_plans order by id";
$ans=$obj->select($sql);
if(isset($_GET['id']))
{
	$sqld="delete from membership_plans where id = '".$_GET['id']."' ";
	$obj->sql_query($sqld);
	echo "<script> window.location.href = 'list_plans.php' </script>";	
}
?>
<style>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="btn-group" style="margin-bottom:10px; float:right">
                    <a href="add_new_plan.php"><button id="sample_editable_1_new" class="btn green">
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <?php for($i=0;$i<count($ans);$i++){?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $ans[$i]['plan_display_name'];?></td>	
                                    <td><?php echo $ans[$i]['plan_duration'];?></td>	
                                    <td><?php echo $ans[$i]['plan_amount'];?></td>	
                                    <td><a href="add_new_plan.php?id=<?php echo $ans[$i]['id'];?>" class="btn mini purple"><i class="icon-edit"></i> Manage</a></td>                                        
                                </tr>
                                <? }?>                              
                            </tbody>
                        </table>
