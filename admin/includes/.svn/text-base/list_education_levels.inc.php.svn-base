<?php 
$sql = "SELECT e.*,d.name FROM education_details e JOIN degrees d ON e.degree_in = d.id";
$ans=$obj->select($sql);
if(isset($_GET['id']))
{
	$sqld="delete from education_details where id = '".$_GET['id']."' ";
	$obj->sql_query($sqld);
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="btn-group" style="margin-bottom:10px; float:right">
                    <a href="add_new_education_level.php"><button id="sample_editable_1_new" class="btn green">
                    Add New <i class="icon-plus"></i>
                    </button></a>
                </div>
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i>List Education Levels</div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <?php for($i=0;$i<count($ans);$i++){?>
                                <tr>
                                    ...
                                    <td><?php echo $ans[$i]['degree'];?></td>	                                    
                                    <td class="hidden-480">
                                    <a href="list_education_course.php?eid=<?php echo $ans[$i]['id'];?>" class="btn mini green"><i class="icon-edit"></i> Manage</a>
                                    </td>
                                    <td class="hidden-480">
...
<script type="text/javascript">
	function doYouWantTo(id){
	  ...
	  if(doIt){
		window.location.href = 'list_education_levels.php?id='+id;
	  }
	  else{
		  return false;
	  }
