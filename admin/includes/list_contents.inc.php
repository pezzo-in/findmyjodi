...
if(isset($_GET['id']))
{
	$sqld="delete from contents where id = '".$_GET['id']."' ";
	$obj->sql_query($sqld);
	echo "<script> window.location.href = 'list_contents.php' </script>";	
}
?>
<style>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="list_contents.php">List Contents</a>                        
                    </li>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <?php for($i=0;$i<count($ans);$i++){?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ($i+1);?></td>
                                    <td><?php echo $ans[$i]['page_name'];?></td>
                                    <td><?php echo $ans[$i]['page_url'];?></td>	
                                   <td><a href="add_new_content.php?id=<?php echo $ans[$i]['id'];?>" class="btn mini purple"><i class="icon-edit"></i> Manage</a></td>                                         
                                </tr>
                                <? }?>                              
                            </tbody>
                        </table>
