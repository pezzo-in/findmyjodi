...
<div class="container-fluid">
    <div class="row">
        <div class="min_part col-md-12">
            <div class="loginBG"></div>
            <!--top Bg start-->
            <div class="top_bg col-md-12 col-sm-12 col-sx-12">
                <!--logo start-->
                <div class="logo col-md-offset-0 col-xs-offset-5 col-sm-offset-5"><a href="index.php"><img
                        src="images/landing-logo.png"/></a></div>
                <!--input box start-->
                <div class="box_left col-sm-12 col-md-offset-4 col-md-6 col-xs-12">
